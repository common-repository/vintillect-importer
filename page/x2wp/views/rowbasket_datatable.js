  ...
  #renderRows() {
    ...
    if (this.#groupingFunction) { this.#baskets = this.#groupingFunction(ordered); }
      ...
      for (const record of ordered) {
        if (! (record[this.#groupingField] in this.#baskets)) { this.#baskets[ record[this.#groupingField] ] = []; }
        this.#baskets[ record[this.#groupingField] ].push(record);
      }
    }

    this.#basketSortedKeys = Object.keys(this.#baskets);
    if (this.#orderByDirection === 'DESC' && this.#groupingField === 'timestamp') {
