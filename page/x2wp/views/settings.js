const viSettingsObj = {
  ...
  getJobStatus: function() {
    ...
    jQuery.getJSON(jobStatusU + uploadId, function(response) {
      if (response['error']) {
        ...
        const stageArr = ['new', 'downloadDataFiles', 'parseTweets', 'parseCircleTweets', 'parseLike', 'messageHtml', 'uploadProcessedFiles', 'complete'];
  ...
  sendAjaxConfig: function(response, altSuccessMsg) {
    ...
    var data = {
      'action': 'x2wp_update_config', // AJAX action name registered in the PHP code
