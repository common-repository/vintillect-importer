...
class Fb2wp_Settings_View {
  private $pluginName = 'fb2wp';
  private $settingsGroup = 'fb2wp_settings';
  private $optionsGroup = 'fb2wp_options';

  public function display_view($hasAllowedImportsOption, $configSettings) {
    print "<div id='tutorial-link'><a target='video-tutorial' href='https://vintillect.com/vintillect-importer/video.php?page=vintillect-importer&tab=settings'>Settings Tutorial</a><br /><a target='help-instructions' href='https://vintillect.com/vintillect-importer/fb2wp/help.html#settings'>Help Instructions</a></div></div>\n";
      ...
      ?>
        ...
        <table style="width:85%;">
          <tbody>
            ...
            <tr>
              <td>
                <form method="post" action="https://vintillect.com/vintillect-importer/upload.php" target="vintillectcomfb2wp">
                  <input type="hidden" name="website" id="vi-wp-website" value="<?php echo esc_url(get_site_url()) ?>" />
                  <input type="hidden" name="socmedproj" value="fb2wp" />
                  <button class="btn btn-success" type="submit"><span class="dashicons dashicons-upload" style="float:left;font-size:2rem;margin-right:1rem;margin-top: 0.5rem;"></span> Upload Facebook Data File<br />on Vintillect.com</button>
                </form>
              </td>
